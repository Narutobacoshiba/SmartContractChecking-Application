...
sqlFomular = "INSERT INTO LTLTemplate (lteid,name,formula,formula_text,template_type,description) VALUES (%s,%s,%s,%s,%s,%s,%s)"
multi = [ 
    ...
    "test","type0","outOfRange(x) is a proposition defining the conditions for overflow and underflow for the variable x w.r.t the range of its type which we delimit by defining lower and higher thresholds (minThreshold and maxThreshold respec tively).")
]
mycursor.executemany(sqlFomular,multi)
