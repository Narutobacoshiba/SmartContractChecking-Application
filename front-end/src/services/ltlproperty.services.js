...
export class LTLTemplate extends BaseService {
  ...
  static async createLTLTemplate(id, l_name, l_formula, l_template_type, l_description) {
    const param = {
      lteid: id,
      name: l_name,
      formula: l_formula,
  ...
  static async updateLTLTemplate(id, l_name, l_formula, l_template_type, l_description) {
    const param = {
      lteid: id,
      name: l_name,
      formula: l_formula,
