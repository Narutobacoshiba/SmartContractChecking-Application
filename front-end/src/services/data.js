...
var listCommonSmartContracts = [
  ...
  { id: 2, name: "Property 222: Fairness", date_modified: 1608110465663, type: "common" },
...
export function GetSmartContractFunctionInfor(list_smart_contract) {
  const data_example = {
    1: {
      name: "Blind Action", list_gvs: [{ name: "GV1" }, { name: "GV2" }],
    ...
    2: {
      name: "Property 2: Fairness what's up", list_gvs: [{ name: "GV1" }, { name: "GV2" }, { name: "GV3" }],
      list_functions: [{ name: "Function 1", list_lvs: [{ name: "LV1" }, { name: "LV2" }, { name: "LV3" }, { name: "LV4" }], },
      { name: "Function 2", list_lvs: [{ name: "AK1" }, { name: "AK2" }, { name: "AK3" }] },
      { name: "Function 3", list_lvs: [{ name: "MV1" }, { name: "MV2" }] },
      { name: "Function 4", list_lvs: [{ name: "TH1" }, { name: "TH2" }, { name: "TH3" }, { name: "TH4" }, { name: "TH5" }] }]
    ...
    3: {
      name: "Modules CPNC", list_gvs: [{ name: "GV1" }, { name: "GV2" }, { name: "GV6" }],
      list_functions: [{ name: "Function 1", list_lvs: [{ name: "LV1" }, { name: "LV2" }, { name: "LV3" }, { name: "LV4" }], },
      { name: "Function 2", list_lvs: [{ name: "AK1" }, { name: "AK2" }, { name: "AK3" }] },
      { name: "Function 3", list_lvs: [{ name: "MV1" }, { name: "MV2" }] },
      { name: "Function 4", list_lvs: [{ name: "TH1" }, { name: "TH2" }, { name: "TH3" }, { name: "TH4" }, { name: "TH5" }] }]
    ...
    4: {
      name: "Remote Control with auto MCM", list_gvs: [{ name: "GV1" }, { name: "GV2" }, { name: "GV5" }],
      list_functions: [{ name: "Function 1", list_lvs: [{ name: "LV1" }, { name: "LV2" }, { name: "LV3" }, { name: "LV4" }], },
      { name: "Function 2", list_lvs: [{ name: "AK1" }, { name: "AK2" }, { name: "AK3" }] },
      { name: "Function 3", list_lvs: [{ name: "MV1" }, { name: "MV2" }] },
      { name: "Function 4", list_lvs: [{ name: "TH1" }, { name: "TH2" }, { name: "TH3" }, { name: "TH4" }, { name: "TH5" }] }]
    ...
    5: {
      name: "Way back home", list_gvs: [{ name: "GV1" }, { name: "GV2" }, { name: "GV8" }],
      list_functions: [{ name: "Function 1", list_lvs: [{ name: "LV1" }, { name: "LV2" }, { name: "LV3" }, { name: "LV4" }], },
      { name: "Function 2", list_lvs: [{ name: "AK1" }, { name: "AK2" }, { name: "AK3" }] },
      { name: "Function 3", list_lvs: [{ name: "MV1" }, { name: "MV2" }] },
      { name: "Function 4", list_lvs: [{ name: "TH1" }, { name: "TH2" }, { name: "TH3" }, { name: "TH4" }, { name: "TH5" }] }]
...
var SmartContractCode = {
  1: "1st smart contract code", 2: "2nd smart contract code", 3: "3rd smart contract code",
  4: "4th smart contract code", 5: "5th smart contract code",
  6: "6th smart contract code", 7: "7th smart contract code",
  8: "8th smart contract code", 9: "9th smart contract code",
  10: "10th smart contract code", 11: "11th smart contract code",
  12: "12th smart contract code", 13: "13th smart contract code",
  14: "14th smart contract code", 15: "15th smart contract code",
  16: "16th smart contract code", 17: "17th smart contract code",
...
export function GetContext() {
  return [
    ...
    { id: 2, context: "DCR", des: "DCR: User will choose the DCR context by clicking on the \"Load a Context\" button." },
    { id: 3, context: "...", des: "..." },
...
export function GetDataSmartContact() {
  const proData = new Promise(function (resolve, reject) {
    axios.get('/json').then(response => resolve(response)).catch(err => reject(err))
  })
