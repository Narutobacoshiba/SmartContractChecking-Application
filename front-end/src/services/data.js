...
export function GetSmartContractFunctionInfor(list_smart_contract) {
  const data_example = {
    1: {
      name: "Mathematics for Engineering", list_gvs: [{ name: "GV1" }, { name: "GV2" }],
    ...
    2: {
      name: "Property 2: Fairness", list_gvs: [{ name: "GV1" }, { name: "GV2" }, { name: "GV3" }],
      list_functions: [{ name: "Function 1", list_lvs: [{ name: "LV1" }, { name: "LV2" }, { name: "LV3" }, { name: "LV4" }], },
      { name: "Function 2", list_lvs: [{ name: "AK1" }, { name: "AK2" }, { name: "AK3" }] },
      { name: "Function 3", list_lvs: [{ name: "MV1" }, { name: "MV2" }] },
      { name: "Function 4", list_lvs: [{ name: "TH1" }, { name: "TH2" }, { name: "TH3" }, { name: "TH4" }, { name: "TH5" }] }]
    ...
    3: {
      name: "Course competencies", list_gvs: [{ name: "GV1" }, { name: "GV2" }, { name: "GV6" }],
      list_functions: [{ name: "Function 1", list_lvs: [{ name: "LV1" }, { name: "LV2" }, { name: "LV3" }, { name: "LV4" }], },
      { name: "Function 2", list_lvs: [{ name: "AK1" }, { name: "AK2" }, { name: "AK3" }] },
      { name: "Function 3", list_lvs: [{ name: "MV1" }, { name: "MV2" }] },
      { name: "Function 4", list_lvs: [{ name: "TH1" }, { name: "TH2" }, { name: "TH3" }, { name: "TH4" }, { name: "TH5" }] }]
    ...
    4: {
      name: "Build Web Apps with Vue JS 3 & Firebase", list_gvs: [{ name: "GV1" }, { name: "GV2" }, { name: "GV5" }],
      list_functions: [{ name: "Function 1", list_lvs: [{ name: "LV1" }, { name: "LV2" }, { name: "LV3" }, { name: "LV4" }], },
      { name: "Function 2", list_lvs: [{ name: "AK1" }, { name: "AK2" }, { name: "AK3" }] },
      { name: "Function 3", list_lvs: [{ name: "MV1" }, { name: "MV2" }] },
      { name: "Function 4", list_lvs: [{ name: "TH1" }, { name: "TH2" }, { name: "TH3" }, { name: "TH4" }, { name: "TH5" }] }]
    ...
    5: {
      name: "Advanced Techniques for Modeling and Verification", list_gvs: [{ name: "GV1" }, { name: "GV2" }, { name: "GV8" }],
      list_functions: [{ name: "Function 1", list_lvs: [{ name: "LV1" }, { name: "LV2" }, { name: "LV3" }, { name: "LV4" }], },
      { name: "Function 2", list_lvs: [{ name: "AK1" }, { name: "AK2" }, { name: "AK3" }] },
      { name: "Function 3", list_lvs: [{ name: "MV1" }, { name: "MV2" }] },
      { name: "Function 4", list_lvs: [{ name: "TH1" }, { name: "TH2" }, { name: "TH3" }, { name: "TH4" }, { name: "TH5" }] }]
