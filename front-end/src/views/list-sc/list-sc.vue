      ...
      <div id="table-section">
        ...
        <div id="table-body">
          ...
          <div id="table-content">
            <div
              v-for="(sc, idx) in list_smart_contracts[chosen_table]"
              :key="idx"
              class="table-row"
            >
...
export default {
  ...
  mounted() {
    this.list_smart_contracts.common = GetDataSmartContact();
    console.log(this.list_smart_contracts)
  ...
  methods: {
    ...
    addSmartContract() {
      this.$router.push({
        name: "AddSc",
        params: { options: this.chosen_table },
      });
    },
